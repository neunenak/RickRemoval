function rickremoval_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
rickremoval_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				rickremoval_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
rickremoval_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
rickremoval_xmlhttpRequester.prototype.setupRequestEvent =
